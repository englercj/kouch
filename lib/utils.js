...
exports.walk = function walk(path, obj, cb) {
...
exports.getValue = function getValue(path, obj) {
    var ret;

    walk(path, obj, function (o, k) {
        ret = o[k];
    });
...
exports.setValue = function setValue(path, obj, value) {
    walk(path, obj, function (o, k) {
        o[k] = value;
    });

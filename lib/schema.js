...
function Schema(obj, options) {
    ...
    // ensure the documents get an auto _uid unless otherwise specified
    var autoId = !this.paths['_id'] && this.options._id;
    if (autoId) {
        this.add({ _id: { type: String, auto: true } });
    }

    // ensure the documents get an id getter unless otherwise specified
    var autoIdGetter = !this.paths['id'] && this.options.id;
    if (autoIdGetter) {
...
function idGetter() {
    ...
    return this.$__._id = (this._id == null) ? null : String(this._id);
}
 ...
 */
Schema.prototype.defaultOptions = function defaultOptions(options) {

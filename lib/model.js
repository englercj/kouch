...
Model.create = function (doc, cb) {
    ...
    // TODO: This is better as a multi insert?
...
Model.key = Model.prototype.key = function (key) {
    ...
    return
        (this.schema.key.prefix ? this.schema.key.prefix : '') +
        this.get(this.schema.key.path) +
...
Model.prototype.isModified = function (path) {
    return path
            ? this._cache.modifiedPaths.indexOf(path) !== -1
                ...
                get: function () {
                    ...
                    if (!scope._cache.auto[path]) {
                        ...
                        if (typeof type.autoValue === 'function') {
                            scope.set(path, typ.autoValue.call(scope));
                        }
                        // for now assume uuid
                        else {

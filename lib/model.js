...
Model.insert = function (key, value, options, cb) {
};

Model.insertMulti = function (kvPairs, options, cb) {
};
...
Model.prototype.load = function (key, options, cb) {
    ...
    var self = this;
    this.bucket.get(key, options, function (err, result) {
